...
export const projectsData = [
  ...
  },
  {
    ...
    description: "Online Hotel Booking Platform: Choose, Reserve, Travel!",
    languages: "HTML, CSS",
    team: "Taoufik Boussemousse - Papa Arona Diop",
  },
  {
    type: "MOBILE-APP",
    ...
    description: "This application is an online sales platform specializing in electronic and technological products. Our application offers a diverse range of high-quality electronic products, ranging from smartphones and laptops to gadgets and electronic accessories.",
    languages: "Java",
    team: "Taoufik Boussemousse  - Evan Cholette - Antoine Ouellet - Cong Tai Ho - Charles-Maximilien Gros - Sara Salek",
  },
  {
    ...
    description: "An application designed for efficient contact management, allowing you to easily add, edit, and delete contacts.",
    languages: "C#",
    team: "Taoufik Boussemousse - Evan Cholette",
  },
  {
    type: "CONSOLE-APP",
    title: "Space Invader 2",
    image: "space-invader",
    link: null,
    source: "https://github.com/BoussemousseT/Space-Invaders-2/tree/main/TP%20-%20D03",
    description: "A classic arcade game where you defend the Earth against an alien invasion.",
    languages: "C, C++",
    team: "Taoufik Boussemousse - Antoine Ouellet - Evan Cholette",
  },
  {
    type: "DESKTOP-APP",
    title: "Battleship",
    ...
    description: "Battleship is a board game in which two players must place 'ships' on a secret grid and attempt to 'hit' the opponent's ships. The winner is the one who manages to sink (i.e., hit all the squares) all of the opponent's ships before their own ships are all sunk.",
    languages: "Java",
    team: "Taoufik Boussemousse - Antoine Ouellet",
  },
  {
    type: "WEB-APP",
    ...
    description: "This website offers freelance services for sale. Sign up, explore services by category, add to your cart, adjust quantities, remove services, proceed to checkout, send your order via email, and save it in the database.",
    languages: "Java, JavaScript, Bootstrap, HTML, CSS",
    team: "Taoufik Boussemousse  - Evan Cholette",
  },
  {
    type: "MOBILE-APP",
    ...
    description: "Explore recipes from around the world by choosing from various categories, discover delicious recipes, and follow the detailed steps to prepare dishes with this Android application.",
    languages: "Java",
    team: "Taoufik Boussemousse  - Evan Cholette - Charles-Maximilien Gros",
  },
  {
    type: "WEB-APP",
